    ...
    return (
        <div id="cmt_write_warp">
            <div id="cmt_info">
                <div className="total">
                    <span className="icon">
                        <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="1" fill="none" strokeLinecap="round" strokeLinejoin="round" className="css-i6dzq1">
            ...
            <div id="cmt_write" className="cmt_write">
                ...
                <div className="opt">
                    ...
                    <label htmlFor="cmt_submit" className={["btn", "submit", "disable"].join(" ")}>
                        <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="css-i6dzq1">
